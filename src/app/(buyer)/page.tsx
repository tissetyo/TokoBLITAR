    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="px-6 pt-6">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #fecdd3 0%, #fdba74 30%, #fb923c 60%, #e07965 100%)",
          }}
        >
          ...
          <div className="absolute right-0 top-0 h-full w-1/2 opacity-40">
            ...
            />
            <div
              className="absolute right-40 bottom-10 h-56 w-56 rounded-full"
              style={{
            ...
            />
            <div
              className="absolute right-20 top-1/2 h-32 w-32 rounded-full"
              style={{
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <p className="mt-4 text-sm text-white/70">
              Jelajahi produk UMKM terbaik dari Kabupaten Blitar. Dukung usaha
              lokal.
            </p>
            ...
            {latestProducts && latestProducts.length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="p-3">
                            ...
                            <h3 className="mt-0.5 text-sm font-medium text-gray-800 line-clamp-1">
                              {p.name}
                            </h3>
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl bg-gray-50 py-20 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Jadilah penjual pertama di TokoBLITAR!
                </p>
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400 line-clamp-1">
                      {store.description || "UMKM Kabupaten Blitar"}
                    </p>
                  </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            ...
            <p className="text-xs text-gray-400">
              © {new Date().getFullYear()} Marketplace UMKM Blitar
            </p>
          </div>
        </div>
      </footer>
